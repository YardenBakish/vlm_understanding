...
class GMFlow(nn.Module):
    ...
    def forward(self, img0, img1,
        ...
        print(f"feature 0: {len(feature0_list)}")
        print(f"feature 0: {feature0_list[0].shape}")
        print(f"num_scale 0: {self.num_scales}")
        ...
        for scale_idx in range(self.num_scales):
            ...
            print(f"feature 0 after pos: {feature0_list[0].shape}")

            # Transformer
            feature0, feature1 = self.transformer(feature0, feature1, attn_num_splits=attn_splits)

            print(f"feature 0 after attention: {feature0.shape}")


            # correlation and softmax
            if corr_radius == -1:  # global matching
                print(f"pred_bidir_flow: {pred_bidir_flow.shape}")
