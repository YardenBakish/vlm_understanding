...
def fetch_dataloader(args, TRAIN_DS='C+T+K+S+H'):
    ...
    if args.stage == 'chairs':
        ...
        if TRAIN_DS == 'C+T+K+S+H':
            ...
            train_dataset = sintel_clean # 100*sintel_clean + 100*sintel_final + 200*kitti  + 5*hd1k + things

        elif TRAIN_DS == 'C+T+K/S':
            train_dataset =  sintel_clean  #100*sintel_clean + 100*sintel_final + things
