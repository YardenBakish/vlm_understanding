...
class SmolVLMVisionTransformer(SmolVLMPreTrainedModel):
    ...
    def masked_optical_flow_loss(self,pred, target, magnitude_threshold=384):
        """
    ...
    def forward(
        ...
        if self.use_cfg and self.training:
            ...
            loss_rec = 0.1* self.masked_optical_flow_loss(flow, movement_vectors)
            ...
            #loss_rec =  self.movement_vector_predictor(last_hidden_state,movement_vectors,  )
...
class SmolVLMModel(SmolVLMPreTrainedModel):
    ...
    def get_image_features(self, pixel_values: torch.FloatTensor, pixel_attention_mask: torch.LongTensor = None,  movement_vectors:torch.LongTensor = None, ):
        ...
        image_hidden_states, movement_vectors_loss = self.vision_model(pixel_values=pixel_values,pixel_values_copy=pixel_values_copy, patch_attention_mask=patch_attention_mask, movement_vectors= movement_vectors, )
    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        if pixel_values is not None and image_hidden_states is not None:
            ...
            image_hidden_states, movement_vectors_loss = self.get_image_features(pixel_values, pixel_attention_mask, movement_vectors, )
